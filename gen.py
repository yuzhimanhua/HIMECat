...
def bow_pseudodocs(relevant_nodes, expand_num, background_array, sequence_length, len_avg,
					len_std, num_doc, interp_weight, vocabulary_inv, embedding_mat, class_emb, kappa, save_dir=None, total_num=50):
	...
	for i in range(n_classes):
		...
		if relevant_node.children:
			...
			for children_node in children_nodes:
				...
				discourses = np.concatenate((discourses, discourses_child), axis=0)
		else:
